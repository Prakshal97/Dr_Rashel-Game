    ...
    <div className="lb-screen">
      ...
      <div className="lb-content">
        ...
        <div className="lb-header anim-fade-in-down">
          ...
          <p className="body-sm text-muted" style={{ marginTop: '4px', letterSpacing: '0.1em' }}>
            Hydration Champions
          </p>
        </div>
        ...
        {leaderboard.length === 0 ? (
          <div className="lb-empty anim-fade-in-up">
            ...
            <p className="body-lg text-muted text-center">
              No scores yet.<br />
              <span className="text-aqua">Be the first Hydration Champion!</span>
            </p>
          </div>
        ) : (
          rest.length > 0 && (
              ...
              {rest.map((entry, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="lb-score text-aqua">
                      {entry.score.toLocaleString()}
                    </span>
                  </div>
                )
